let {is, extend, trim,removeFromArray,dateFormat,fromTime,ONE_MIN,decodeUnicode,encodeToUnicode,sort,shuffle,randomInteger,toArray} =require( '../dist/index');
...
require('./common/array.test.js')({removeFromArray,sort,shuffle,toArray});
